...
${charCountInstruction}
${options?.includeImageDesc === false ? "- 이미지 관련 표시는 아무것도 넣지 마세요" : `- **이미지 삽입 필수** — 위 분석 결과의 "🖼️ 이미지 전략 분석"의 이미지 배치 계획을 반드시 따르세요
...
- H1 제목 바로 아래에 첫 번째 이미지를 반드시 배치하세요 (독자의 첫인상 = 썸네일)
- 각 H2 소제목 아래에도 해당 섹션을 대표하는 이미지를 1장 이상 배치하세요`}${options?.productName ? `\n\n### 제품 배치 규칙 (매우 중요 — 반드시 준수)
